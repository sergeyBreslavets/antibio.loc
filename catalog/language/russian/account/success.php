...
// Text
$_['text_message']  = '<p>Поздравляем! Ваш Личный Кабинет был успешно создан.</p><p>Теперь вы можете воспользоваться дополнительными возможностями: участвовать в конкурсах,принимать участие в грантах, создовать инициативные группы, рассказывать о своих проектах, измененять свою контактную информацию и многое другое.</p><p>Если у Вас есть какие-либо вопросы,  <a href="%s">напишите нам</a>.</p>';
